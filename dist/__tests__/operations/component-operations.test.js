...
describe('ComponentOperations', () => {
    let componentOps;
    beforeEach(() => {
        componentOps = new ComponentOperations(mockHttpClient, mockLogger, mockConfig.aem);
        jest.clearAllMocks();
    });
    ...
    describe('updateComponent', () => {
        ...
        it('should handle null and undefined values in properties', async () => {
            ...
            const result = await componentOps.updateComponent(request);
            expect(result.success).toBe(true);
            expect(mockHttpClient.post).toHaveBeenCalledWith('/content/test/page1/jcr:content/text', expect.any(URLSearchParams), expect.any(Object));
        });
    });
...
//# sourceMappingURL=component-operations.test.js.map