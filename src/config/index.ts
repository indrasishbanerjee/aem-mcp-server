...
import { IConfig, AEMConfig, MCPConfig, ServerConfig, SecurityConfig, LoggingConfig } from '../interfaces/index.js';
 ...
 */
function loadAEMConfig(): AEMConfig {
  return {
...
function loadSecurityConfig(): SecurityConfig {
  return {
    auth: {
      ...
      type: (process.env.AUTH_TYPE as 'basic' | 'jwt' | 'api-key') || 'basic',
 ...
 */
export function getEnvironmentConfig(environment: 'development' | 'staging' | 'production'): IConfig {
