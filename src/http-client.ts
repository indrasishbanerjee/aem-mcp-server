 ...
 */
export function createAxiosInstance(config: IConfig): AxiosInstance {
 ...
 */
export function createUploadAxiosInstance(config: IConfig): AxiosInstance {
  const axiosConfig: AxiosRequestConfig = {
    baseURL: config.aem.host,
 ...
 */
export function createStreamingAxiosInstance(config: IConfig): AxiosInstance {
  const axiosConfig: AxiosRequestConfig = {
    baseURL: config.aem.host,
